// Set an object of expressions to match the Markdown syntax for the types and styles.
const expressions = {
  types: [
    { tag: "h1", pattern: /^#(?!#)(.*)/ },
    { tag: "h2", pattern: /^##(?!#)(.*)/ },
...
/**
 * Wrap the text with the specified HTML tag.
 * @param text
 * @param tag
 * @returns {string} The text wrapped with the specified HTML tag.
 */
...
/**
 * Parse the Markdown syntax to HTML.
 * @param markdown
